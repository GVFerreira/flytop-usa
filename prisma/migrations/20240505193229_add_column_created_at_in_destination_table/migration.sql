...
INSERT INTO "new_Destination" ("airport_stopover", "departure_airport", "departure_date", "destination_airport", "flight_company", "flight_stopover", "id", "name", "return_date", "value") SELECT "airport_stopover", "departure_airport", "departure_date", "destination_airport", "flight_company", "flight_stopover", "id", "name", "return_date", "value" FROM "Destination";
