        ...
        <div className="grid gap-2">
          ...
          <nav>
            <ul className="space-y-2">
              <li>
                <a href="https://www.instagram.com/flytoptravels" target="_blank" className="flex gap-2 hover:underline">
              ...
              <li>
                <a href="https://www.facebook.com/profile.php?id=61564149964439&mibextid=LQQJ4d" target="_blank" className="flex gap-2 hover:underline">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" className="size-5" fill="currentColor" viewBox="0 0 16 16">
