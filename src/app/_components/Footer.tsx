...
export default function Component() {
  return (
    <footer className="bg-sky-50 pt-10 pb-5">
      <div className="container grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3">
        <div className="flex items-start flex-col gap-4">
          <Logotipo />
          <p className="text-sm text-muted-foreground">We connect successful people to the best flights in the world</p>
        </div>
        <div className="grid gap-2">
          ...
          <nav>
            <ul className="space-y-2">
              <li>
                <Link href="https://instagram.com/" target="_blank" className="flex gap-2 hover:underline">
              ...
              <li>
                <Link href="https://facebook.com" target="_blank" className="flex gap-2 hover:underline">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" className="size-5" fill="currentColor" viewBox="0 0 16 16">
              ...
              <li>
                <Link href="https://twitter.com" target="_blank" className="flex gap-2 hover:underline">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" className="size-5" fill="currentColor" viewBox="0 0 16 16">
