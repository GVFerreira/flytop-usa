  ...
  return (
    <>
      ...
      <main style={{flex: "1 1 0"}}>
        <section className="container mx-auto  text-center md:py-32 py-16 bg-white">
          <div>
            <h1 className="text-5xl text-sky-950 text-center font-bold leading-[4rem]">
          ...
          <div className="container mb-10">
            ...
            <div className="grid grid-cols-1 gap-16 md:grid-cols-3">
              <div className="text-center">
                <Image className="rounded-xl border-2 border-slate-950 shadow-lg mb-4 w-10/12 mx-auto" src="/team/vinicius.png" alt="VINÍCIUS STIBORSKI" width={500} height={500} />
              ...
              <div className="text-center">
                <Image className="rounded-xl border-2 border-slate-950 shadow-lg mb-4 w-10/12 mx-auto" src="/team/bruno.jpg" alt="BRUNO STIBORSKI" width={500} height={500} />
              ...
              <div className="text-center">
                <Image className="rounded-xl border-2 border-slate-950 shadow-lg mb-4 w-10/12 mx-auto" src="/team/rafael.jpg" alt="RAFAEL BALBINOT" width={500} height={500} />
